...
public class SpellDev2 extends Item {
    ...
    public SpellDev2(Properties properties) {
        super(properties);
    }
...
//            }
            ...
            if (!worldIn.isRemote) {
                ...
                //we know how many blocks to change when reaching the side
                ...
                int x;
                int sinkholepowerposX = currentblockpos.getX();
                for (x = currentblockpos.getX(); x <= sinkholepowerposX+spellpower-1; ++x) {
